...
public class Airplanes {
    ...
    public static Airplane findAirplane(Airplane[] airplanes, int flightRangeFrom, int flightRangeTo, int cargoCapacityFrom, int cargoCapacityTo, int passengersCapacityFrom, int passengersCapacityTo){
    ...
    public static Airplane findAirplaneConsole(Airplane[] aircompany){
        ...
        int cargoCapacityFrom = scanner.nextInt();
        System.out.println("Enter maximum cargo capacity: ");
        int cargoCapacityTo = scanner.nextInt();
